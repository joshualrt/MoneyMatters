...
class ReimbursementsControllerTest < ActionController::TestCase
  ...
  test "should create reimbursement" do
    assert_difference('Reimbursement.count') do
      post :create, reimbursement: { amount: @reimbursement.amount, description: @reimbursement.description, email: @reimbursement.email, name: @reimbursement.name, studentid: @reimbursement.studentid }
    end
  ...
  test "should update reimbursement" do
    patch :update, id: @reimbursement, reimbursement: { amount: @reimbursement.amount, description: @reimbursement.description, email: @reimbursement.email, name: @reimbursement.name, studentid: @reimbursement.studentid }
    assert_redirected_to reimbursement_path(assigns(:reimbursement))
  end
